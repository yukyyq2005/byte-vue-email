                ...
                <div class="col-span-1 space-y-1">
                    ...
                    <Popover class="relative shadow-sm rounded-md mt-1">
                        ...
                        <div class="block w-full space-y-0.5 border border-gray-300 py-0.5 px-0 text-sm rounded-md bg-white css-ywad9z-container">
                            <div class="flex ml-1 flex-wrap mr-7 items-center">
                                ...
                                <input class="flex-1" v-model="inputValue1" @input="checkComma" @blur="addConditions" @keydown.enter="addConditions" type="text" style="color: inherit; background: 0px center; opacity: 1; grid-area: 1 / 2 / auto / auto; font: inherit; min-width: 100px; border: 0px; margin: 0px; outline: 0px; padding: 5px;">
                            </div>
                        </div>
