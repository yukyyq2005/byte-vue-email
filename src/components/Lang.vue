<template>
    ...
    <div>
        <select @change="handleChange" v-model="langValue" id="m03oekpf" name="language" class="bg-white lang-arrow text-sm text-gray-700 pt-1.5 rounded-md border-gray-300 hover:bg-gray-50 cursor-pointer">
