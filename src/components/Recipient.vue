        ...
        <Popover class="relative shadow-sm rounded-md mt-1">
            ...
            <div class="block w-full space-y-0.5 border border-gray-300 py-0.5 px-0 text-sm rounded-md bg-white">
                <div class="flex flex-wrap mr-7 items-center">
                    ...
                    <input class="flex-1" v-model="inputValue" @input="checkComma" @blur="addConditions" @keydown.enter="addConditions" type="text" style="color: inherit; background: 0px center; opacity: 1; grid-area: 1 / 2 / auto / auto; font: inherit; min-width: 100px; border: 0px; margin: 0px; outline: 0px; padding: 5px;">
                </div>
            </div>
